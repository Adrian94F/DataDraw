...
d3.json("sim2.json", function (data) {
    ...
    var obj = {name: "0-25% similarity", data: similarity, color: "red", turboThreshold: 100000};
    var obj2 = {name: "26-50% similarity", data: similarity2, color: "orange", turboThreshold: 100000};
    var obj3 = {name: "51-75% similarity", data: similarity3, color: "yellow", turboThreshold: 100000};
    var obj4 = {name: "76-100% similarity", data: similarity4, color: "green", turboThreshold: 100000};
